...
/**
 * A {@link PdfViewCtrlTabHostFragment2} that allows for real-time annotation collaboration. Used
 * in conjunction with {@link CollabViewerTabFragment2}.
 * <p>
 ...
 */
public class CollabViewerTabHostFragment2 extends PdfViewCtrlTabHostFragment2 implements
        OpenAnnotationListListener,
        CollabViewerTabFragment2.CollabTabListener,
        CollabManager.AdvancedViewerListener {

    protected Class<? extends CollabViewerTabFragment2> mTabFragmentClass; // default tab fragment class
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mTabFragmentClass = (Class<? extends CollabViewerTabFragment2>) getArguments().getSerializable(BUNDLE_TAB_FRAGMENT_CLASS);
        }
        ...
        mCollabManager.setAdvancedViewerListener(this);
    }
    ...
    /**
     * Returns a {@link CollabViewerTabFragment2} class object that will be used to
    ...
    public TabLayout.Tab addTab(@Nullable Bundle args, String tag, String title, String fileExtension, String password, int itemSource) {
        if (args == null) {
            args = CollabViewerTabFragment2.createBasicPdfViewCtrlTabBundle(tag, title,
    ...
    protected void setFragmentListeners(Fragment fragment) {
        ...
        if (fragment instanceof CollabViewerTabFragment2) {
            CollabViewerTabFragment2 tabFragment = (CollabViewerTabFragment2) fragment;
    ...
    protected DialogFragmentTab createAnnotationDialogTab() {
        ...
        if (!(currentFragment instanceof CollabViewerTabFragment2) || context == null) {
            return null;
        }
        String docId = ((CollabViewerTabFragment2) currentFragment).getDocumentId();
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        menuEditPages = getViewOverflowOptionMenuItem(R.id.action_editpages);
        if (menuEditPages != null) {
            menuEditPages.setVisible(false);
        }
        ...
        menuExport = getViewOverflowOptionMenuItem(R.id.action_export_options);
        if (menuExport != null) {
            menuExport.setVisible(false);
        }
    }
    ...
    protected void onShareOptionSelected() {
        ...
        if (currentFragment instanceof CollabViewerTabFragment2) {
    ...
    public PDFViewCtrl getPdfViewCtrl() {
        ...
        if (currentFragment != null) {
            return currentFragment.getPDFViewCtrl();
        }
        return null;
    }
}
