...
public class AppUtils {
     ...
     * If using this function, {@link DocumentPreviewCache} and
        ...
        if (!Fresco.hasBeenInitialized()) {
            Fresco.initialize(applicationContext,
                    ImagePipelineConfig.newBuilder(applicationContext)
                            ...
                            .setPoolFactory(new FrescoCustomPoolFactory(PoolConfig.newBuilder().build(), MemoryChunkType.BUFFER_MEMORY))
