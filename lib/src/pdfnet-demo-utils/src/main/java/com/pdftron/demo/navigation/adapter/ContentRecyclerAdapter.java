...
public class ContentRecyclerAdapter extends RecyclerView.Adapter<ContentRecyclerAdapter.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case VIEW_TYPE_ACTION:
                view = LayoutInflater.from(mContext).inflate(R.layout.file_info_drawer_action_item, parent, false);
                break;
            case VIEW_TYPE_SPACER:
                view = LayoutInflater.from(mContext).inflate(R.layout.file_info_drawer_spacer_item, parent, false);
                break;
            default:
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        FileBrowserTheme theme = FileBrowserTheme.fromContext(mContext);
        ...
        switch (getItemViewType(position)) {
            ...
            case VIEW_TYPE_BUTTON:
                ...
                break;
            case VIEW_TYPE_ACTION:
                bindActionsViewHolder(jsonObject, holder, theme);
                break;
            case VIEW_TYPE_CONTENT:
    ...
    protected void bindActionsViewHolder(JsonObject jsonObject, ItemViewHolder holder, FileBrowserTheme theme) {
    }
    ...
    public int getItemViewType(int position) {
        ...
        boolean isAction = jsonObject.get(ContentInfoKey.IsAction).getAsBoolean();
        if (isAction) {
            return VIEW_TYPE_ACTION;
        }

        boolean isSpacer = jsonObject.get(ContentInfoKey.IsSpacer).getAsBoolean();
        if (isSpacer) {
