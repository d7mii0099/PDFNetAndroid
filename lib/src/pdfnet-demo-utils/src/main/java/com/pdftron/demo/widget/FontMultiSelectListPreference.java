...
public class FontMultiSelectListPreference extends androidx.preference.MultiSelectListPreference {
    ...
    private void init() {
        ...
        mPopulateFontInfoTask.setCallback(new PopulateFontInfoTask.Callback() {
            ...
            public void getFontInfo(HashSet<String> defaultValues, CharSequence[] entries, CharSequence[] entryValues) {
                ...
                if (!isInitialized) {
                    onSetInitialValue(defaultValues);
                ...
                // font pref list changed, we want to reload font
