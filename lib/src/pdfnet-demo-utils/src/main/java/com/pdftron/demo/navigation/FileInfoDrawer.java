...
public class FileInfoDrawer implements
    ...
    public void show(FileInfoDrawer.Callback callback) {
        ...
        if (mCallback != null) {
            ...
            BaseFileInfo fileInfo = mCallback.onPrepareFileInfo(FileInfoDrawer.this);
            if (fileInfo != null) {
                mFragment.setFile(fileInfo);
            }
    ...
    public void onActionClicked() {
        if (mCallback != null) {
            mCallback.onActionClicked(FileInfoDrawer.this);
        }
    }
    ...
    public interface Callback {
        ...
        BaseFileInfo onPrepareFileInfo(FileInfoDrawer drawer);

        void onActionClicked(FileInfoDrawer drawer);
    }
}
