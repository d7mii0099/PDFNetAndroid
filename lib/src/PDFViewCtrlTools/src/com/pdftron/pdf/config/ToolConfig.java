...
public class ToolConfig {
    ...
    private ToolConfig() {
        ...
        mToolQMItemPair.put(R.id.qm_perimeter_measure, ToolMode.PERIMETER_MEASURE_CREATE);
        mToolQMItemPair.put(R.id.qm_area_measure, ToolMode.AREA_MEASURE_CREATE);
        mToolQMItemPair.put(R.id.qm_rect_area_measure, ToolMode.RECT_AREA_MEASURE_CREATE);
        ...
        mToolQMItemPair.put(R.id.qm_rect_link, ToolMode.RECT_LINK);
        ...
        mToolQMItemPair.put(R.id.qm_form_combo_box, ToolMode.FORM_COMBO_BOX_CREATE);
        mToolQMItemPair.put(R.id.qm_form_list_box, ToolMode.FORM_LIST_BOX_CREATE);
        mToolQMItemPair.put(R.id.qm_form_signature, ToolMode.FORM_SIGNATURE_CREATE);
        mToolQMItemPair.put(R.id.qm_form_radio_group, ToolMode.FORM_RADIO_GROUP_CREATE);
        ...
        mToolQMItemPair.put(R.id.qm_rect_redaction, ToolMode.RECT_REDACTION);
        ...
        mToolAnnotationToolbarItemPair.put(R.id.controls_annotation_toolbar_tool_perimeter_measure, ToolMode.PERIMETER_MEASURE_CREATE);
        mToolAnnotationToolbarItemPair.put(R.id.controls_annotation_toolbar_tool_area_measure, ToolMode.AREA_MEASURE_CREATE);
        ...
        mToolAnnotationToolbarItemPair.put(R.id.controls_annotation_toolbar_tool_stamp, ToolMode.SIGNATURE);
        mToolAnnotationToolbarItemPair.put(R.id.controls_annotation_toolbar_tool_sound, ToolMode.SOUND_CREATE);

        mToolAnnotationToolbarItemPair.put(R.id.controls_form_field_toolbar_widget_text, ToolMode.FORM_TEXT_FIELD_CREATE);
        mToolAnnotationToolbarItemPair.put(R.id.controls_form_field_toolbar_widget_checkbox, ToolMode.FORM_CHECKBOX_CREATE);
        mToolAnnotationToolbarItemPair.put(R.id.controls_form_field_toolbar_widget_radio, ToolMode.FORM_RADIO_GROUP_CREATE);
        mToolAnnotationToolbarItemPair.put(R.id.controls_form_field_toolbar_widget_listbox, ToolMode.FORM_LIST_BOX_CREATE);
        mToolAnnotationToolbarItemPair.put(R.id.controls_form_field_toolbar_widget_combobox, ToolMode.FORM_COMBO_BOX_CREATE);
        mToolAnnotationToolbarItemPair.put(R.id.controls_form_field_toolbar_widget_signature, ToolMode.FORM_SIGNATURE_CREATE);
        ...
        mNoAnnotPermissionQMList.add(R.id.qm_calibrate);
        mNoAnnotPermissionQMList.add(R.id.qm_redact);
        ...
        mAnnotHandlerToolPair.put(AnnotStyle.CUSTOM_ANNOT_TYPE_PERIMETER_MEASURE, ToolMode.ANNOT_EDIT_ADVANCED_SHAPE);
        mAnnotHandlerToolPair.put(AnnotStyle.CUSTOM_ANNOT_TYPE_AREA_MEASURE, ToolMode.ANNOT_EDIT_ADVANCED_SHAPE);
