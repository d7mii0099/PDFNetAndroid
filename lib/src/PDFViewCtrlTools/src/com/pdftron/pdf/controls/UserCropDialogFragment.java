...
public class UserCropDialogFragment extends DialogFragment {
    ...
    private void initUI(final View view) {
        ...
        final MaterialCardView cardView = view.findViewById(R.id.card_view);
        cardView.setCardBackgroundColor(theme.chipBackgroundColor);
        AppCompatImageButton button = view.findViewById(R.id.prev_button);
        button.setColorFilter(theme.iconColor);
        button = view.findViewById(R.id.next_button);
        button.setColorFilter(theme.iconColor);
        mPageNumberTextView.setTextColor(theme.textColor);
        TextView textView = view.findViewById(R.id.crop_label);
    ...
    public void onConfigurationChanged(@NonNull Configuration newConfig) {
        ...
        if (getView() instanceof ViewGroup) {
            ...
            View view = onCreateView(LayoutInflater.from(viewGroup.getContext()), viewGroup, null);
    ...
    public static final class Theme {
        ...
        Theme(int chipBackgroundColor, int iconColor, int textColor) {
        ...
        public static Theme fromContext(@NonNull Context context) {
            final TypedArray a = context.obtainStyledAttributes(
                    null, R.styleable.CropDialogTheme, R.attr.pt_crop_dialog_style, R.style.PTCropDialogTheme);

            int chipBackgroundColor = a.getColor(R.styleable.CropDialogTheme_chipBackgroundColor, context.getResources().getColor(R.color.pt_subtle_utility_color));
            int iconColor = a.getColor(R.styleable.CropDialogTheme_iconColor, context.getResources().getColor(R.color.pt_secondary_color));
            int textColor = a.getColor(R.styleable.CropDialogTheme_textColor, context.getResources().getColor(R.color.pt_body_text_color));
            a.recycle();

            return new Theme(chipBackgroundColor, iconColor, textColor);
        }
    }
}
