...
public class AnalyticsHandlerAdapter {
    ...
    public void sendEvent(int eventId, @NonNull List<Map<String, String>> paramList) {
        if (BuildConfig.DEBUG) {
    ...
    /**
     * Custom key identifiers for analytics
     */
    ...
    public String getKeyString(CustomKeys keyId) {
        switch (keyId) {
            case ALL_FILE_BROWSER_EVENTS:
                return "all_files_events";
            case ALL_FILE_BROWSER_MODE:
                return "all_files_browser_mode";
            case TAB_ERROR:
                return "tab_error";
            default:
                return "not_known";
    ...
    public final static int OPEN_FILE_SYSTEM_PICKER = 3;
    ...
    public final static int SCREEN_BACKUP = 9;
    public final static int SCREEN_HOME = 10;
    public final static int SCREEN_BROWSE = 11;
    public final static int SCREEN_ACTIONS = 12;
    public final static int SCREEN_ACTIONS_FILES = 13;
    ...
    // viewer save copy identifier
    public final static int VIEWER_SAVE_COPY_IDENTICAL = 1;
    public final static int VIEWER_SAVE_COPY_FLATTENED = 2;
    public final static int VIEWER_SAVE_COPY_CROPPED = 3;
    public final static int VIEWER_SAVE_COPY_REDUCED = 4;
    public final static int VIEWER_SAVE_COPY_PASSWORD_PROTECTED = 5;
    public final static int VIEWER_SAVE_COPY_EXPORT_TO = 6;

    public String getViewerSaveCopy(int itemId) {
        switch (itemId) {
            case VIEWER_SAVE_COPY_IDENTICAL:
                return "identical";
            case VIEWER_SAVE_COPY_FLATTENED:
                return "flattened";
            case VIEWER_SAVE_COPY_CROPPED:
                return "cropped";
            case VIEWER_SAVE_COPY_REDUCED:
                return "reduced";
            case VIEWER_SAVE_COPY_PASSWORD_PROTECTED:
                return "password_protected";
            case VIEWER_SAVE_COPY_EXPORT_TO:
                return "export_to";
            default:
                return "not_known";
        }
    ...
    public final static int ANNOTATION_TOOL_SOUND = 27;
    public final static int ANNOTATION_TOOL_REDACTION = 28;
    public final static int ANNOTATION_TOOL_PERIMETER_MEASURE = 29;
    public final static int ANNOTATION_TOOL_AREA_MEASURE = 30;

    public final static int FORM_TOOL_TEXT = 31;
    public final static int FORM_TOOL_SIGNATURE = 32;
    public final static int FORM_TOOL_CHECKBOX = 33;
    public final static int FORM_TOOL_RADIOGROUP = 34;
    public final static int FORM_TOOL_LISTBOX = 35;
    public final static int FORM_TOOL_COMBOBOX = 36;

    public final static int FILL_AND_SIGN_TOOL_TEXT = 37;
    public final static int FILL_AND_SIGN_TOOL_DATE = 38;
    public final static int FILL_AND_SIGN_TOOL_CHECKMARK = 39;
    public final static int FILL_AND_SIGN_TOOL_CROSS = 40;
    public final static int FILL_AND_SIGN_TOOL_DOT = 41;
    ...
    public String getAnnotationTool(int screenId) {
        switch (screenId) {
            ...
            case ANNOTATION_TOOL_RULER:
                return "ruler";
            case ANNOTATION_TOOL_REDACTION:
                return "redaction";
            case ANNOTATION_TOOL_MULTI_SELECT:
                return "multi_select";
            case ANNOTATION_TOOL_SOUND:
                return "sound";
            case ANNOTATION_TOOL_PERIMETER_MEASURE:
                return "perimeter_measure";
            case ANNOTATION_TOOL_AREA_MEASURE:
                return "area_measure";
            case FORM_TOOL_CHECKBOX:
                return "checkbox";
            case FORM_TOOL_RADIOGROUP:
                return "radio_group";
            case FORM_TOOL_SIGNATURE:
                return "signature_widget";
            case FORM_TOOL_TEXT:
                return "text_widget";
            case FORM_TOOL_LISTBOX:
                return "listbox_widget";
            case FORM_TOOL_COMBOBOX:
                return "combobox_widget";
            case FILL_AND_SIGN_TOOL_TEXT:
                return "fill_text";
            case FILL_AND_SIGN_TOOL_DATE:
                return "fill_date";
            case FILL_AND_SIGN_TOOL_CHECKMARK:
                return "fill_check_mark";
            case FILL_AND_SIGN_TOOL_CROSS:
                return "fill_cross";
            case FILL_AND_SIGN_TOOL_DOT:
                return "fill_dot";
            default:
                return "not_known";
        }
    ...
    public String getAnnotToolByAnnotType(int annotType) {
        ...
        switch (annotType) {
            ...
            case AnnotStyle.CUSTOM_ANNOT_TYPE_FREE_TEXT_DATE:
                annotTool = FILL_AND_SIGN_TOOL_DATE;
                break;
            case AnnotStyle.CUSTOM_ANNOT_TYPE_FREE_TEXT_SPACING:
                annotTool = FILL_AND_SIGN_TOOL_TEXT;
                break;
            case Annot.e_Text:
    ...
    public final static int VIEW_MODE_READING_SETTINGS = 17;
    ...
    public String getViewMode(int itemId) {
        switch (itemId) {
            ...
            case VIEW_MODE_READING_SETTINGS:
    ...
    // edit outline event type
    public final static String EVENT_EDIT_OUTLINE_ADD = "add_outline_entry";
    public final static String EVENT_EDIT_OUTLINE_MOVE = "move_outline_entry";
    public final static String EVENT_EDIT_OUTLINE_EDIT = "edit_outline_entry";
    public final static String EVENT_EDIT_OUTLINE_DELETE = "delete_outline_entry";
    public final static String EVENT_EDIT_OUTLINE_OPEN = "edit_create";
    ...
    public final static int EVENT_VIEWER_RAGE_SCROLLING = 63;
    public final static int EVENT_CREATE_IMAGE_SIGNATURE = 64;
    public final static int EVENT_VIEWER_SAVE_COPY = 65;
    public final static int EVENT_SCREEN_SYSTEM_PICKER = 66;
    public final static int POPULATE_FILES_TASK = 67;
    public final static int FILE_PICKER_DIALOG_LOCAL = 68;
    public final static int FILE_PICKER_DIALOG_EXTERNAL = 69;
    public final static int FILE_PICKER_DIALOG_FAVORITE = 70;
    public final static int FILE_PICKER_DIALOG_RECENT = 71;
    public final static int HTML2PDF_CONVERSION = 72;
    public final static int EVENT_FORM_FIELD_TOOLBAR = 73;
    public final static int EVENT_AUTO_DRAW_ITEM_SELECTED = 74;
    public final static int EVENT_AUTO_DRAW_OPTION = 75;
    public final static int EVENT_STYLE_PICKER_OPTIONS = 76;
    public final static int EVENT_URI_READ_CHECK = 77;
    public final static int EVENT_FILTER_ERROR_CHECK = 78;
    public final static int EVENT_NEW_ANNOTATION_TOOLBAR = 79;
    public final static int EVENT_NEW_ANNOTATION_TOOLBAR_TOOL_CLOSE = 80;
    public final static int EVENT_TOOLBAR_SWITCHER = 81;
    public final static int EVENT_TOOLBAR_REORDER = 82;
    public final static int EVENT_TOOLBAR_REORDER_TOP_3 = 83;
    public final static int EVENT_FAV_TOOLBAR_TOOL_COUNT = 84;
    public final static int EVENT_FAV_TOOLBAR_TOOL_DUPLICATE = 85;
    public final static int EVENT_VIEWER_SAVE_EXPORT_TO_COPY = 86;
    public final static int EVENT_ANNOTATION_FILTER = 87;
    public final static int EVENT_QUICK_MENU_REFLOW_ACTION = 88;
    public final static int EVENT_EDIT_OUTLINE = 89;
    public final static int EVENT_SETTING_CHANGE_GENERAL = 701;
    public final static int EVENT_SETTING_CHANGE_VIEWING = 702;
    public final static int EVENT_SETTING_CHANGE_TABS = 703;
    public final static int EVENT_SETTING_CHANGE_ANNOTATION = 704;
    public final static int EVENT_SETTING_CHANGE_STYLUS = 705;
    public final static int EVENT_SETTING_CHANGE_ABOUT = 706;
    public final static int EVENT_FILE_BROWSER = 707;
    ...
    protected String getEvent(int eventId) {
        switch (eventId) {
            ...
            case EVENT_ANNOTATION_TOOLBAR:
                return "annotation_toolbar";
            case EVENT_NEW_ANNOTATION_TOOLBAR:
                return "new_annotation_toolbar";
            case EVENT_NEW_ANNOTATION_TOOLBAR_TOOL_CLOSE:
                return "new_annotation_toolbar_tool_close";
            case EVENT_TOOLBAR_SWITCHER:
                return "toolbar_switcher";
            case EVENT_TOOLBAR_REORDER:
                return "toolbar_reorder";
            case EVENT_TOOLBAR_REORDER_TOP_3:
                return "toolbar_reorder_top_3";
            case EVENT_FAV_TOOLBAR_TOOL_COUNT:
                return "fav_toolbar_tool_count";
            case EVENT_FAV_TOOLBAR_TOOL_DUPLICATE:
            ...
            case EVENT_QUICK_MENU_ACTION:
                return "quickmenu";
            case EVENT_QUICK_MENU_REFLOW_ACTION:
            ...
            case EVENT_STYLE_PICKER_OPTIONS:
            ...
            case EVENT_VIEWER_RAGE_SCROLLING:
                return "switch_to_vertical_scroll";
            case EVENT_CREATE_IMAGE_SIGNATURE:
                return "create_image_signature";
            case EVENT_VIEWER_SAVE_COPY:
                return "viewer_save_copy";
            case EVENT_VIEWER_SAVE_EXPORT_TO_COPY:
                return "viewer_save_export_to_copy";
            case EVENT_SCREEN_SYSTEM_PICKER:
                return "screen_system_picker";
            case POPULATE_FILES_TASK:
                return "populate_file_task";
            case FILE_PICKER_DIALOG_FAVORITE:
                return "file_picker_dialog_favorite";
            case FILE_PICKER_DIALOG_LOCAL:
                return "file_picker_dialog_local";
            case FILE_PICKER_DIALOG_RECENT:
                return "file_picker_dialog_recent";
            case FILE_PICKER_DIALOG_EXTERNAL:
                return "file_picker_dialog_external";
            case HTML2PDF_CONVERSION:
                return "HTML2PDF_webpage_conversion";
            case EVENT_FORM_FIELD_TOOLBAR:
                return "form_field_toolbar";
            case EVENT_AUTO_DRAW_ITEM_SELECTED:
                return "auto_draw_item_selected";
            case EVENT_AUTO_DRAW_OPTION:
                return "auto_draw_option";
            case EVENT_URI_READ_CHECK:
                return "event_uri_read_check2";
            case EVENT_FILTER_ERROR_CHECK:
                return "event_filter_error_check";
            case EVENT_ANNOTATION_FILTER:
                return "event_annotation_filter";
            case EVENT_EDIT_OUTLINE:
                return "event_edit_outline";
            case EVENT_SETTING_CHANGE_GENERAL:
                return "screen_Settings_General";
            case EVENT_SETTING_CHANGE_VIEWING:
                return "screen_Settings_Viewing";
            case EVENT_SETTING_CHANGE_TABS:
                return "screen_Settings_Tabs";
            case EVENT_SETTING_CHANGE_ANNOTATION:
                return "screen_Settings_Annotation";
            case EVENT_SETTING_CHANGE_STYLUS:
                return "screen_Settings_Stylus";
            case EVENT_SETTING_CHANGE_ABOUT:
                return "screen_Settings_About";
            case EVENT_FILE_BROWSER:
                return "file_browser";
            default:
                return "not_known";
        }
    ...
    public String getQuickMenuAction(@IdRes int itemId, @Nullable ToolManager.ToolModeBase toolMode) {
        ...
        if (itemId == R.id.qm_duplicate) return "duplicate";
    ...
    public final static int NEXT_ACTION_SHAPE_RULER = 15;
    public final static int NEXT_ACTION_SHAPE_CALLOUT = 16;
