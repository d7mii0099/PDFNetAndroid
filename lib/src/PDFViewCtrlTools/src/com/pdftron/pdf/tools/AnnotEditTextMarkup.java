    ...
    public boolean onQuickMenuClicked(QuickMenuItem menuItem) {
        ...
        if (mAnnot != null) {
            ...
            // Add note to the annotation
                ...
                AnnotEdit annotEdit = (AnnotEdit) toolManager.createTool(ToolMode.ANNOT_EDIT, this);
                if (annotEdit.onQuickMenuClicked(menuItem)) {
                    return true;
                }
        ...
        if (mPdfViewCtrl.hasSelection()) {
            ...
            try {
                ...
                for (AnnotUpdateInfo updateInfo : updateInfoList) {
                    ...
                    if (textMarkup != null) {
                        mPdfViewCtrl.update(textMarkup, pageNum);
