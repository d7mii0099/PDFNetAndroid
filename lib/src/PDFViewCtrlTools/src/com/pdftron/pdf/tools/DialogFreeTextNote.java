...
public class DialogFreeTextNote extends DialogAnnotNote {
    ...
    private int mHorizontalTextAlignment = Gravity.NO_GRAVITY;
    private int mVerticalTextAlignment = Gravity.NO_GRAVITY;
    ...
    public void initTextBox(String note) {
        ...
        int toggleColorInt = ((ToolManager) mPdfViewCtrl.getToolManager()).getFreeTextToggleButtonColorInt();
        if (toggleColorInt != -1) {
            mToggleButton.getDrawable().mutate().setColorFilter(toggleColorInt, PorterDuff.Mode.SRC_ATOP);
        } else {
    ...
    public void disableToggleButton() {
        ...
        if (toggleColorInt != -1) {
            mToggleButton.getDrawable().mutate().setColorFilter(toggleColorInt, PorterDuff.Mode.SRC_ATOP);
            mToggleButton.getDrawable().mutate().setAlpha(55);
        } else {
    ...
    public void setHorizontalTextAlignment(int gravity) {
        ...
        mTextBox.setGravity(mHorizontalTextAlignment | mVerticalTextAlignment);
    }
