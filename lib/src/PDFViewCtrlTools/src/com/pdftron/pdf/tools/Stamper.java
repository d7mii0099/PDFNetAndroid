...
public class Stamper extends Tool {
    ...
    public final static String STAMPER_ROTATION_DEGREE_ID = "pdftronImageStampRotationDegree";
    ...
    public boolean createImageStamp(Uri uri, int imageRotation, String filePath) {
        ...
        try {
            ...
            */
            ...
            if (getAbsoluteStampWidth() > 0) {
                stampWidth = getAbsoluteStampWidth();
            }
            if (getAbsoluteStampHeight() > 0) {
                stampHeight = getAbsoluteStampHeight();
            }
    ...
    /**
     * Gets fixed width for the stamp annotation in PDF page space.
     *
     * @return absolute width of stamp
     */
    ...
    /**
     * Gets fixed height for the stamp annotation in PDF page space.
     *
     * @return absolute height of stamp
     */
