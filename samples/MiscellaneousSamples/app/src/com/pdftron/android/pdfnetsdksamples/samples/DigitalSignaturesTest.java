...
public class DigitalSignaturesTest extends PDFNetSample {
	...
	public void runOnBackground() {
		...
		try
		{
			PDFDoc doc = new PDFDoc(Utils.getAssetTempFile(INPUT_PATH + "waiver.pdf").getAbsolutePath());
		...
		try
		{
			certifyPDF(Utils.getAssetTempFile(INPUT_PATH + "waiver_withApprovalField.pdf").getAbsolutePath(),
				"PDFTronCertificationSig",
				Utils.getAssetTempFile(INPUT_PATH + "pdftron.pfx").getAbsolutePath(),
				"password",
				Utils.getAssetTempFile(INPUT_PATH + "pdftron.bmp").getAbsolutePath(),
		...
		try
		{
			signPDF(Utils.getAssetTempFile(INPUT_PATH + "waiver_withApprovalField_certified.pdf").getAbsolutePath(),
				"PDFTronApprovalSig",
				Utils.getAssetTempFile(INPUT_PATH + "pdftron.pfx").getAbsolutePath(),
				"password",
		...
		try
		{
			clearSignature(Utils.getAssetTempFile(INPUT_PATH + "waiver_withApprovalField_certified_approved.pdf").getAbsolutePath(),
				"PDFTronCertificationSig",
		...
		try
		{
			if (!verifyAllAndPrint(Utils.getAssetTempFile(INPUT_PATH + "waiver_withApprovalField_certified_approved.pdf").getAbsolutePath(),
				Utils.getAssetTempFile(INPUT_PATH + "pdftron.cer").getAbsolutePath()))
			{
				result = false;
			}
		}
		...
		try
		{
			if (!verifySimple(Utils.getAssetTempFile(INPUT_PATH + "waiver_withApprovalField_certified_approved.pdf").getAbsolutePath(),
				Utils.getAssetTempFile(INPUT_PATH + "pdftron.cer").getAbsolutePath()))
			{
				result = false;
			}
