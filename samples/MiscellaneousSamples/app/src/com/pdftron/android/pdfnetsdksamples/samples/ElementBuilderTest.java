...
public class ElementBuilderTest extends PDFNetSample {
	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            Font font;
            File file = Utils.getAssetTempFile(INPUT_PATH + "font.ttf");
            ...
            doc.save((Utils.createExternalFile("element_builder.pdf", mFileList).getAbsolutePath()), SDFDoc.SaveMode.REMOVE_UNUSED, null);
            doc.close();
