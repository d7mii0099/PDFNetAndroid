 ...
 */
public class PageLabelsTest extends PDFNetSample {
	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            //-----------------------------------------------------------
            {
                ...
                doc.save(Utils.createExternalFile("newsletter_with_pagelabels.pdf", mFileList).getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
                doc.close();
            ...
            //-----------------------------------------------------------
            {
                PDFDoc doc = new PDFDoc((Utils.createExternalFile("newsletter_with_pagelabels.pdf", mFileList).getAbsolutePath()));
                doc.initSecurityHandler();
            ...
            //-----------------------------------------------------------
            {
                ...
                doc.save(Utils.createExternalFile("newsletter_with_pagelabels_modified.pdf", mFileList).getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
