...
class RedactionActivity : FeatureActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initialToolbarTag = DefaultToolbars.TAG_REDACTION_TOOLBAR
    ...
    override fun onPostCreate(savedInstanceState: Bundle?) {
        ...
        mPdfViewCtrlTabHostFragment!!.addOnToolbarChangedListener { newToolbar ->
            if (newToolbar == DefaultToolbars.TAG_VIEW_TOOLBAR) {
                button.text = getString(R.string.open_redaction_toolbar)
            } else {
                button.text = getString(R.string.close_redaction_toolbar)
            }
        }
    }
    ...
    private fun addControl() {
        ...
        button.setCompoundDrawablesWithIntrinsicBounds(
            R.drawable.ic_annotation_redact_black_24dp,
            0,
            0,
            0
        )
        ...
        button.setOnClickListener {
            if (mPdfViewCtrlTabHostFragment!!.currentToolbarTag != null) {
                if (mPdfViewCtrlTabHostFragment!!.currentToolbarTag == DefaultToolbars.TAG_VIEW_TOOLBAR) {
                    mPdfViewCtrlTabHostFragment!!.openToolbarWithTag(DefaultToolbars.TAG_REDACTION_TOOLBAR)
                } else {
