    ...
    override fun run(outputListener: OutputListener?) {
        ...
        try {
            ...
            try {
                ...
                draw.export(pg, Utils.createExternalFile("tiger_92dpi.png", mFileList).absolutePath)

                mOutputListener!!.println("Example 1: tiger_92dpi.png")

                // Export the same page as TIFF
                draw.export(pg, Utils.createExternalFile("tiger_92dpi.tif", mFileList).absolutePath, "TIFF")
                doc.close()
            } catch (e: Exception) {
            ...
            try {
                ...
                draw.export(page, Utils.createExternalFile("tiger_200x400_rot180.png", mFileList).absolutePath, "PNG", gray_hint)
                ...
                draw.export(page, Utils.createExternalFile("tiger_400x200_stretch.jpg", mFileList).absolutePath, "JPEG")
                ...
                draw.export(page, Utils.createExternalFile("tiger_zoom_900dpi.png", mFileList).absolutePath, "PNG")
                mOutputListener!!.println("Example 5: tiger_zoom_900dpi.png")

                // -------------------------------------------------------------------------------
                // Example 6)
                draw.setImageSize(50, 50)       // Set the thumbnail to be 50x50 pixel image.
                draw.export(page, Utils.createExternalFile("tiger_zoom_50x50.png", mFileList).absolutePath, "PNG")
            ...
            try {
                ...
                val pg = doc.getPage(1)
                draw.export(pg, Utils.createExternalFile("out1.tif", mFileList).absolutePath, "TIFF", cmyk_hint)
            ...
            try {
                val text_doc = PDFDoc(Utils.getAssetTempFile(PDFNetSample.INPUT_PATH + "lorem_ipsum.pdf")!!.absolutePath)
