...
class StamperTest : PDFNetSample() {
    ...
    override fun run(outputListener: OutputListener?) {
        ...
        try {
            val doc = PDFDoc(Utils.getAssetTempFile(PDFNetSample.INPUT_PATH + input_filename + ".pdf")!!.absolutePath)
        ...
        try {
            ...
            val fish_doc = PDFDoc(Utils.getAssetTempFile(PDFNetSample.INPUT_PATH + "fish.pdf")!!.absolutePath)
